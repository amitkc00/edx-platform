...
class TestGetCertificates(TestCase):
    ...
    def test_get_certificates(self, mock_get_credentials):
        ...
        expected.append({
            ...
            'url': get_program_certificate_url(self.program_certificate_url),
        })
    ...
    def test_get_program_certificate_url(self, mock_get_credentials):  # pylint: disable=unused-variable
        ...
        actual = get_program_certificate_url(self.program_certificate_url)
